...
- Integration tests for HTTP listener modes (explicit proxy and transparent
  HTTP interception), HTTPS CONNECT MITM, and transparent HTTPS (HTTP/1.1 and
  HTTP/2), including HTTP/1.1 upgrade/WebSocket tunneling in transparent mode.
